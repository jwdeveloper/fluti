...
<div class="feedback">
    <Hint title="Fatalnie">
        ...
        <label class="angry" onclick={()=> onClick(1)}>
    ...
    <Hint title="Słabe">
        <label class="sad" onclick={()=> onClick(2)}>
    ...
    <Hint title="Może być">
        <label class="ok" onclick={()=> onClick(3)}>
            <input name="feedback" value="3" type="radio"/>
            <div></div>
        </label>
    </Hint>
    <Hint title="Dobrze">
        <label class="good" onclick={()=> onClick(4)}>
    ...
    <Hint title="Rewelacja">
        <label class="happy" onclick={()=> onClick(5)}>
...
<style>
    ...
    .feedback {
        ...
        --normal-mouth: #2e2e3d;
        --normal-eye: #282734;
        --active: rgba(248, 218, 105, 0.76);
        --active-shadow: #f4b555;
        --active-shadow-top: #eae5d1;
        --active-mouth: #f05136;
        --active-eye: #313036;
        --active-tear: #76b5e7;
    ...
    @-webkit-keyframes toggle {
        50% {
            transform: translateY(var(--middle-y, 0)) scale(
